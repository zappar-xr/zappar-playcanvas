...
var CubemapRenderer = pc.createScript('cubemapRenderer') as Z.Type.CubemapRenderer;
...
CubemapRenderer.prototype.initialize = function () {
    ...
    for (var i = 0; i < 6; i++) {
        ...
        var renderTarget = new (pc as any).RenderTarget(this.app.graphicsDevice, this.cubeMap, {
            depth: this.depth,
            face: i
        });
